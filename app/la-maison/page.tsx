...
import { TexteRevele } from '@/components/texte-revele'
            ...
            <TexteRevele>
              <section id="avant" className="colonne scroll-mt-32">
                ...
                <p className="lettrine mt-6">
                  ...
                  choses dont nous vivons encore : un plancher qui grince exactement au milieu, et
                  des étagères en sapin montées trop haut pour ce qu&apos;on y rangeait. Le premier
                  devis reçu proposait de tout démonter. Nous avons gardé les étagères et changé le
                  plancher — ce qui, avec le recul, était l&apos;inverse du raisonnable.
                </p>
                <p className="mt-5">
                  ...
                  c&apos;était qu&apos;il n&apos;y avait plus un seul endroit où entrer sans
                  acheter, et rester une heure.
                </p>

                <NoteMarge>
                  Le plancher grince toujours au milieu. Deux clients réguliers s&apos;en servent
                  pour annoncer leur arrivée sans dire bonjour.
                </NoteMarge>

                <p className="mt-5">
                  Les six premiers mois, nous vendions surtout des cartes postales. Ce n&apos;est
                  pas une coquetterie : c&apos;est la carte postale qui a payé les trois premières
                  commandes d&apos;éditeurs. On a appris, cette année-là, une chose qui n&apos;est
                  pas dans les manuels — une librairie tient d&apos;abord parce que quelqu&apos;un
                  entre, et seulement ensuite parce que quelqu&apos;un achète.
                </p>
              </section>
              ...
              <section id="mur-du-fond" className="colonne mt-16 scroll-mt-32">
                ...
                <p className="mt-6">
                  ...
                  est restée vide un mois entier, parce que nous n&apos;arrivions pas à décider de
                  ce qu&apos;elle recevrait. Un soir, faute de mieux, nous y avons posé les sept ou
                  huit livres qui traînaient depuis l&apos;ouverture sur le comptoir, faute de
                  rayon.
                </p>
                <p className="mt-5">
                  ...
                  trentaine de pages qui décrivait la fabrication d&apos;un seul objet, du début à
                  la fin, sans jamais dire lequel. Aucun de ces quatre livres n&apos;avait de rayon.
                  Tous ont trouvé preneur avant la fin du mois.
                </p>
                ...
                <p className="mt-5">
                  ...
                  pas une relégation : c&apos;est l&apos;endroit le plus visible du magasin, à
                  hauteur de regard, juste en face de la porte. Les gens s&apos;y arrêtent parce
                  qu&apos;ils n&apos;y cherchent rien de précis, et c&apos;est exactement
                  l&apos;état d&apos;esprit dans lequel on trouve quelque chose.
                </p>
            ...
            <TexteRevele>
              <section id="refus" className="colonne scroll-mt-32">
                ...
                <p className="mt-6">
                  ...
                  pendant les heures de fermeture. Elle a aussi une conséquence que nous
                  n&apos;avions pas prévue — elle rend le conseil possible. Quand on demande «
                  c&apos;est bien ? », quelqu&apos;un peut répondre autre chose que « il paraît ».
                </p>
                <p className="mt-5">
                  ...
                  personne de l&apos;équipe, qui l&apos;assume et le signe. Ce trimestre, ce sont
                  les métiers disparus du port fluvial ; le précédent, c&apos;était la littérature
                  écrite en prison.
                </p>
                <p className="mt-5">
                  ...
                  discussions entières avec des visiteurs qui trouvaient étrange de croiser un
                  auteur argentin entre deux auteurs français, à la lettre près. C&apos;est bien
                  pour ça qu&apos;on la garde.
                </p>
              </section>
              ...
              <section id="voix-haute" className="colonne mt-16 scroll-mt-32">
                ...
                <NoteMarge>
                  Sept personnes ce soir-là. Aujourd&apos;hui, la salle plafonne à quarante —
                  au-delà, on n&apos;entend plus celui qui lit.
                </NoteMarge>
              ...
              <section id="aujourdhui" className="colonne mt-16 scroll-mt-32">
                ...
                <p className="mt-5">
                  Ce qui a changé en vingt-huit ans, ce n&apos;est pas le métier, c&apos;est le
                  temps dont disposent les gens qui entrent. Il s&apos;est raccourci. Notre seule
                  réponse a été de ralentir le magasin : moins de titres, plus de place entre les
                  rayons, des chaises, et personne qui vienne demander si l&apos;on cherche quelque
                  chose dans les dix premières minutes.
                </p>
                <p className="mt-5">
                  Le cinquième rayon, lui, n&apos;a pas bougé. Il contient en ce moment
                  trente-quatre livres. Aucun d&apos;eux ne se ressemble, et c&apos;est le seul
                  endroit de la boutique dont nous ne connaissons pas le contenu par cœur.
                </p>
                <p className="mt-8">
                  <Lien
                    href="/catalogue"
