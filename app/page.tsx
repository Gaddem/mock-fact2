    ...
    <>
      ...
      <section className="relative isolate overflow-hidden">
        ...
        <div className="relative mx-auto grid max-w-[var(--contenu-max)] gap-12 px-5 pt-14 pb-[var(--section-y)] sm:px-8 sm:pt-20 lg:grid-cols-[minmax(0,1.35fr)_minmax(0,1fr)] lg:gap-16">
          ...
          <Reveal sens="marge" cascade rang={3}>
        ...
        <div className="mx-auto max-w-[var(--contenu-max)] px-5 py-[var(--section-y)] sm:px-8">
          <Reveal>
            <div className="flex flex-wrap items-end justify-between gap-4">
              ...
              <Lien
                href="/catalogue"
                className="lien flex min-h-11 items-center font-titre text-sm"
              >
          ...
          <Reveal cascade rang={1}>
            <p className="colonne mt-6 text-muted">
              Chaque premier mardi, on vide la table du fond et on recommence. Ce qui reste
              ci-dessous a survécu à la discussion.
            </p>
          </Reveal>
      ...
      {/* Chronique : un vrai bloc de texte long, en pleine page d'accueil.
          Les paragraphes entrent un par un — sur un site dont le sujet est
          le texte long, c'est le texte qui doit avoir le mouvement. */}
      <section className="border-t border-bordure bg-surface">
        <div className="mx-auto max-w-[var(--contenu-max)] px-5 py-[var(--section-y)] sm:px-8">
      ...
      <section className="mx-auto max-w-[var(--contenu-max)] px-5 pb-[var(--section-y)] sm:px-8">
        <div className="border-t border-bordure pt-10">
          <div className="grid gap-8 lg:grid-cols-[minmax(0,1fr)_auto] lg:items-end">
            ...
            <Reveal sens="marge" cascade rang={1}>
